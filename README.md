...
*Rolling Shutter Video Synth (RS-VS)* se referire a todos aquellos dispositivos capaces de producir imagenes y videos a través de la interferencia entre la luz pulsante de un led (estroboscopica, flicker) y el scan rate de una cámara digital CMOS (como la de los celulares).
